                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.about') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea required name="short_description" class="form-control" rows="5" id="short_description">{{ $aboutpage->short_description }}</textarea>
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea required name="description" id="elm1">{{ $aboutpage->description }}</textarea>
                                    </div>
                                </div>
                                <!-- end row -->
